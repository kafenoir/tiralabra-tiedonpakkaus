...
public class LZW {
    ...
    /**
     * Luo sanakirjan sanakirjaA, jossa avaimina ASCII-merkit 0-255 ja arvoina niiden kokonaislukuarvot, sekä
     * sanakirjan sanakirjaB, jossa arvot ja avaimet ovat vaihdettu keskenään. Lisätään kumpaankin myös tyhjennysmerkki ja 
    ...
    /**
     * Koodataan syöte LZW-menetelmällä. 
     * Muuttujassa mjono pidetään käsiteltävänä olevaa syötteen osaa ja muuttujaan merkki asetetaan syötteen seuraava yksittäinen merkki. 
     * Joka kierroksella katsotaan, löytyykö sanakirjasta avainta mjono + merkki vastaava arvo.
     * Löytyy: lisätään merkki mjonoon. 
     * Ei löydy: Tehdään sanakirjaan uusi merkintä avaimella mjono + merkki ja arvoksi annetaan 
     * järjestyksessä seuraava kokonaisluku (numerointi lähtee siitä, mihin alustettu sanakirja loppui, eli 258). 
     * Haetaan sanakirjasta mjonoa vastaava arvo ja lisätään se tulosteeseen (koodi[]).
     * 
    ...
    /**
     * LZW-dekoodaamisessa pohjana käytetään samaa 256-merkin sanakirjaa kuin koodaamisessa sillä erotuksella, että avaimet ja arvot on vaihdettu keskenään. 
     * Muuttujassa vanha pidetään edellisen kierroksen koodia ja muuttujassa uusi seuraavaksi käsiteltävää koodia. Tulostetta muodostetaan hakemalla koodeja 
     * vastaavia merkkijonoja sanakirjasta, laajentaen samalla sanakirjaa samalla periaatteella kuin koodaamisvaiheessa.
     * Jos uutta koodia vastaava merkkijono löytyy sanakirjasta, se asetetetaan työmerkkijonoksi (mjono) ja lisätään tulosteeseen. 
     * Tällöin sanakirjaan lisätään edellisen koodin merkkijono + työmerkkijonon ensimmäinen merkki.
     * Jos uutta koodia vastaavaa merkkijonoa ei löydy sanakirjasta, asetetaan tulostettavaksi työmerkkijonoksi 
     * edellisen koodin merkkijono + edellisen merkkijonon ensimmäinen merkki. Sama yhdistelmä lisätään sanakirjaan.
     * Tämä perustuu siihen, että jos uutta koodia vastaavaa merkkijonoa ei löydy sanakirjasta, täytyy sen olla tällä kierroksella sanakirjaan lisättävä arvo, jolloin sen ensimmäisen merkin
     * täytyy olla sama kuin käsiteltävänä olevan merkkijonon ensimmäinen merkki.
     * 
